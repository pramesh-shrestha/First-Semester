package NextDays;/*Exercise 3.02 The Part1.Exercise3_2.MyDate class Create a class called Part1.Exercise3_2.MyDate that includes
...
public class MyDate
{
  ...
  public void nextDay(int days)
  {
    ...
    if(day > totalDays())
    {
      day = day  - totalDays();
      month += 1;
      //this will store the extra day and store on day
      if(month > 12)
      {
        year += 1;
        month = 1;
