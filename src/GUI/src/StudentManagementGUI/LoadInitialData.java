...
public class LoadInitialData
{
   public static void main(String[] args)
   {
      ...
      try
      {
         studentArray = MyFileHandler.readArrayFromTextFile("GUI/src/StudentManagementGUI/students.txt");
      ...
      try
      {
         MyFileHandler.writeToBinaryFile("GUI/src/StudentManagementGUI/students.bin", students);
      }
      catch (FileNotFoundException e)
      {
