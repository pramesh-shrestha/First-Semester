...
public class StudentManagementGUI extends Application
{
   ...
   private Tab studentsFromCountryTab; //new tab

   private TextArea allStudentsArea;
   private TextArea textArea; //new tab

   private Button getButton;
   private Button updateButton;
   private Button getStudentByCountryBtn; //new tab
   ...
   private TextField nameOfTheCountry; //new tab
   ...
   public void start(Stage window)
   {
      ...
      studentsFromCountryTab = new Tab(("Students From Country")); //new tab
