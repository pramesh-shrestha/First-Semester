package DayOfWeek;/*Exercise 3.02 The Part1.Exercise3_2.MyDate class Create a class called Part1.Exercise3_2.MyDate that includes
...
public class MyDate_Alternative
{
  private int day;
